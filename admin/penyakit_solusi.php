...
<body>
  <div class="background">
    <h1 class="ps-title text-center ">Data Penyakit dan Solusi Penanganannya</h1>
    <div class="h-ps-container gap-3">
      <form name="form3" method="post" onSubmit="return validasi(this);" action="simpanpenyakit.php">
        <table class="table-title" width="667" cellpadding="3" cellspacing="1" align="center">
          <tr>
      ...
      <div class="CSSTableGenerator">
        <table class="p-2" width="100%" cellpadding="3" cellspacing="3" border="1" align="center">
          ...
          while ($data = mysqli_fetch_array($qry)) {
            ...
            <tr bgcolor="#577D86">
              ...
              <td><a title="Edit Penyakit" href="edpenyakit.php?kdubah=<?php echo $data['kd_penyakit']; ?>"><img
                    src="image/edit.jpeg" width="16" height="16" border="0"></a></td>
              <td><a title="Hapus Penyakit" style="cursor:pointer;"
                  onclick="return konfirmasi('<?php echo $data['kd_penyakit']; ?>');"><img src="image/hapus.jpeg"
