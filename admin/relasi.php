...
<body>
	<div class="background">
		<h2 class="ps-title text-center fs-1">Data Relasi</h2>
		<div class="h-ps-container gap-5">
			<?php
...
//$kdgejala= $_REQUEST['kd_gejala'];
			...
			<form id="form1" name="form1" method="post" action="relasisim.php" enctype="multipart/form-data">
				<div>
					<table class="table-title" width="440" border="0" align="center" cellpadding="4" cellspacing="1"
						bordercolor="#F0F0F0">
						<tr>
							<td>Kode</td>
							<td><label>
						...
						<tr>
							...
							<td>Bobot</td>
							<td><input class="mt-3 md-3" name="txtbobot" type="number" id="txtbobot" step="0.01"></td>
		...
		<option value="1">1 | Gejala Biasa</option>
			...
			<table width="60%" border="2" cellpadding="4" cellspacing="1">
				<tr class='table-title' bgcolor="#005B52">
					<td width="32"><strong>No</strong></td>
					<td width="105"><strong>Gejala</strong></td>
					<td width="535"><strong>Nama Penyakit</strong>
				</tr>
				<?php
					...
					<tr bgcolor="#577D86">
						...
						<td valign="top">
							...
							while ($row2 = mysqli_fetch_array($query2)) {
								...
								echo "<tr bgcolor='#577D86' bordercolor='#333333'>";
								echo "<td class='table-isi' width='50'>$row2[kd_gejala]</td>";
								echo "<td class='table-isi' width='300'>$row2[namagejala]</td>";
								echo "<td class='table-isi'width='50'>$row2[bobot]</td>";
								echo "<td class='table-isi' width='20'><a title='Edit Relasi' href='haladmin.php?top=edit_relasi.php&id_relasi=$row2[id_relasi]'>Edit</a></td>";
								echo "<td class='table-isi' width='20'><a title='Hapus Relasi' style='cursor:pointer;' onclick='return konfirmasi($row2[id_relasi])'>Hapus</a></td>";
								echo "</tr>";
								echo "</table>";
							}
							?> <br />
