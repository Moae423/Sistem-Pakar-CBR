...
<body>
  <div class="background">
    <h2 class="ps-title text-center fs-1">Data Gejala-gejala</h2>
    <div class="h-ps-container gap-5">
      <form name="form3" onSubmit="return validasi(this);" method="post" action="simpangejala.php">
        <table class="tab" width="477" border="0" align="center">
          ...
          <tr>
            <td class="table-title" width="95">Kode gejala </td>
            <td width="8">:</td>
            <td width="224">
          ...
          <tr>
            <td class="table-title"> Gejala </td>
            <td>:</td>
            <td>
        ...
        <table class="p-2" width="100%" border="1" align="center" cellpadding="3" cellspacing="0">
          ...
          <tr>
            ...
            <tr bgcolor="#577D86">
              ...
              <td class=" table-isi">
                <?php echo $data['gejala']; ?>
              </td>
              <td class=" table-isi"><a title="Edit Penyakit"
                  href="edgejala.php?kdubah=<?php echo $data['kd_gejala']; ?>"><img src="image/edit.jpeg" width="16"
                    height="16" border="0"></a></td>
              <td class=" table-isi"><a title="Hapus Gejala" style="cursor:pointer;"
                  onclick="return konfirmasi('<?php echo $data['kd_gejala']; ?>');"><img src="image/hapus.jpeg" width="16"
                    height="16"></a></td>
            </tr>
            <?php
            } ?>
